package com.product.service.api.composite.prod;
...
public interface ProductCompositeService {
    ...
    @PostMapping( path = "/product-composite", consumes = "application/json")
    ...
    @GetMapping(path  = "/product-composite/{productId}", produces = "application/json")
